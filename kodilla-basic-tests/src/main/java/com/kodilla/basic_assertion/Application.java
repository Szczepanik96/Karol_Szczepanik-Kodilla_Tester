...
public class Application {
    public static void main(String[] args) {
        ...
        boolean correct = ResultChecker.assertEquals(91, sumResult, 0.1);
        if (correct) {
        ...
        boolean correct1 = ResultChecker.assertEquals(21, subResult, 0.1);
        if (correct1) {
            System.out.println("System działa prawidłowo dla liczb " + a + " i " + b);
        } else {
            System.out.println("System nie działa prawidłowo dla liczb " + a + " i " + b);
        ...
        boolean correct2 = ResultChecker.assertEquals(3136, sqrResult, 0.1);
        if (correct2) {
